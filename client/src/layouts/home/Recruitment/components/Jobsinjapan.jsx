...
//           `http://localhost:3000/crawl/jobsinjapan?curPage=${curPage}`,
//           {
//             method: 'GET',
//           }
//         );
...
//             return (
//               <li
//                 className='p-4 border border-neutral-300 dark:border-neutral-600 rounded-sm'
//                 key={index}
